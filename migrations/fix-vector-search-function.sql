-- Drop the existing function with parameter conflicts
DROP FUNCTION IF EXISTS search_products_by_vector(vector, float, int, text);

-- Create the fixed PostgreSQL function for efficient vector similarity search
